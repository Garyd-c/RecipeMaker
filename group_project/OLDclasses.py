"""
This file contains all the old code in case we need it.
"""

"""//////////////////////////////////////////////   OLD!   /////////////////////////////////////////////////////////////"""

# Create a custom Unique ID
recipe_id_name = "t"
recipe_id_number = "2"
recipe_id = "".join(str(recipe_id_name) + (str(recipe_id_number).rjust(5,"0")))
print(recipe_id)
print(len(recipe_id_number))
